To access the endpoint you need to register first because the endpoints are secured. There is functionality of registering, login, logout, search current user.
